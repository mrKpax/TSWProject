...
<%ArrayList<AddressBean> addresses = (ArrayList<AddressBean>) request.getAttribute("addresses");
  ...
  ArrayList<ClientBean> clients = (ArrayList<ClientBean>) request.getAttribute("clienti");
      ...
      if(clients == null && client.getEmail().equals("WorkInProgress@gmail.com")){
...
<!-- -------------------- ADMIN --------------------- -->
    ...
    <%
        if(client.getEmail().equalsIgnoreCase("WorkInProgress@gmail.com")) {   %>
...
<%    }else{  %>
    ...
    <% if (payments != null){ %>
            ...
            <span class="subtitle">Elimina le tue carte</span>            
         <%  for(int i=0; i<payments.size(); i++) { %>
             ...
             <label for="payment" ><%="****" + payments.get(i).getNumero_carta().substring(payments.get(i).getNumero_carta().length()-4) %></label>
                ...
                <button value="Elimina questa carta" id = "payment"><i class="fa fa-trash" aria-hidden="true"></i></button>
    ...
    <form class="formContainer" action="userdetails?action=addPaymentCard" method="post" onsubmit="event.preventDefault(); validate_payment(this)">
        ...
        <span class="subtitle">Inserisci i dati della carta:</span>
        ...
        <!-- aggiungi carta alla sessione -->
            ...
            <label id="numero_cartaLabel" for="numero_carta">Numero:</label>
            </div>
            ...
            <div class="inputBox special">
            <label for="circuito">Network:</label>
    ...
    <% if (addresses != null){ %>
        ...
        <span class="subtitle">Elimina i tuoi indirizzi</span>
         ...
         <%  for(int i=0; i<addresses.size(); i++) { %>
                ...
                <button value="Elimina questo indirizzo"  id ="address"><i class="fa fa-trash" aria-hidden="true"></i></button>
    ...
    <form class="formContainer" action="userdetails?action=addAddress" method="post" onsubmit="event.preventDefault(); validate_address(this)">
        ...
        <span class="subtitle">Inserisci il tuo indirizzo</span>   
