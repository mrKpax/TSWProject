      ...
      <div class="card">
        ...
        <% if (error != null){%>
          ...
          <div class="inputBox">
            ...
            <label id="emailLabel" for="email">Inserire email:</label>
          </div>
          ...
          <div class="inputBox">
            ...
            <label id="passwordLabel" for="password">Inserire password:</label>
          </div>
          ...
          <div class="footerContainer">
            ...
            <div class="link">
              ...
              <span>oppure torna alla<a href="home"> home </a></span>
            </div>
          </div>
        </div>
      </div>
