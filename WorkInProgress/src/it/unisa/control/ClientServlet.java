...
public class ClientServlet extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        if (client.getEmail().equals("WorkInProgress@gmail.com")){ //se l'utente è l'admin, viene reindirizzato alla pagine di visualizzazioni dei clienti tramite la servlet admin
